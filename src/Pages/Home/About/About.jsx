...
const About = () => {
  return (
    <>
      <Helmet>
        <title>Hungry Place | About Us</title>
      </Helmet>
      <div>
        ...
        <div className="lg:container mx-auto mb-16 mt-10  flex justify-center items-center ">
          <div className="w-3/4 text-center">
            ...
            <p className="mb-12 text-center text-lg text-gray-600">
              ...
              exceptional cuisine with a warm, inviting atmosphere. Our
              dedicated team is here to ensure that every meal is a delight,
              whether you’re celebrating a special occasion or simply enjoying a
              casual meal. We look forward to making your visit truly memorable.
              Come and savor the flavors with us!
            </p>
        ...
        <div className="lg:container mx-auto">
          <div className="relative mx-auto w-full px-5 -mt-14 pb-16 text-gray-800 sm:px-20 md:max-w-screen-lg lg:py-24">
            ...
            <p className="mb-12 text-center text-lg text-gray-600">
              ...
              restaurant. If you have further inquiries, feel free to contact
              us.
            </p>
                  ...
                  <div className="peer-checked:hidden pr-2">
                    <div className="pb-5">
                      <p className="text-sm">
                        ...
                        preferences, ensuring everyone can enjoy a delicious
                        meal.
                      </p>
                    </div>
                  </div>
              ...
              <li className="text-left">
                <label for="accordion-3" className="flex flex-col">
                  ...
                  <div className="peer-checked:hidden pr-2">
                    <div className="pb-5">
                      <p className="text-sm">
                        Absolutely! You can easily make a reservation through
                        our website or mobile app. Simply select the date, time,
                        and number of guests, and you'll receive a confirmation
                        via email.
                      </p>
                    </div>
                  </div>
              ...
              <div class="container mx-auto px-6 md:px-12 xl:px-32">
                <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                  ...
                  <p class="text-base mb-4 text-gray-700 md:text-lg">
                    Our dedicated staff ensures exceptional service, from
                    culinary creations to customer care, making every dining
